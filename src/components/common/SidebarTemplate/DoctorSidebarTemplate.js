...
class DoctorSidebarTemplate extends Component {
  state = {
    toggled: false,
  };
      ...
      >
        ...
        <div className="bg-dark border-end" id="sidebar-wrapper">
          ...
          <div className="list-group list-group-flush">
            ...
            <Link
              to="/doctor-dashboard/doctor-speciality"
              className="list-group-item list-group-item-action bg-dark text-light"
            >
              <i className="fas fa-users"></i> Doctor Specialities
            </Link>
            <Link
              to="/search"
              className="list-group-item list-group-item-action bg-dark text-light"
...
DoctorSidebarTemplate.propTypes = {
...
export default connect(mapStateToProps, { logoutAdmin })(DoctorSidebarTemplate);
